...
int main() {
    const double rho = local_redundancy_ratio(8200.0, 52000.0);
    const double supply = shock_supply(43800.0, 0.25, 8200.0, 2000.0, 500.0);

    std::cout << "Local redundancy ratio: " << rho << "\n";
    std::cout << "Shock scenario available supply: " << supply << " kg\n";
